          ...
          <table role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border-radius:16px;box-shadow:0 4px 18px rgba(0,0,0,0.08);overflow:hidden;border:1px solid #e9e2d9;">
            ...
            <tr>
              <td align="center" style="padding:16px 28px 6px;">
                <div style="font:500 16px/1.6 Inter,Arial,sans-serif;color:#334155;">
                  Спасибо за вашу покупку! Ниже ваш(и) купон(ы) Rubikiai Lux.
                </div>
              </td>
            </tr>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border:1px solid #efe7dc;border-radius:12px;background:#fffcf8;">
                  <tr>
                    <td style="padding:14px 18px;border-bottom:1px solid #efe7dc;">
                      <div style="font:600 13px/1 Inter,Arial,sans-serif;color:#6b7280;text-transform:uppercase;letter-spacing:.6px;margin-bottom:8px;">Сумма</div>
                  ...
                  <tr>
                    <td style="padding:14px 18px;">
                      <div style="font:600 13px/1 Inter,Arial,sans-serif;color:#6b7280;text-transform:uppercase;letter-spacing:.6px;margin-bottom:8px;">Действителен</div>
                      <div style="font:600 16px/1.5 Inter,Arial,sans-serif;color:#0f172a;">
                        До <span style="color:#214235;">${expiresAt}</span> <span style="opacity:.6">(12 месяцев)</span>
                      </div>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td style="padding:10px 24px 0;">
                <div style="font:700 18px/1.3 Georgia,'Times New Roman',Times,serif;color:#214235;">Коды и баланс</div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:8px 24px 22px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border:1px solid #eee;border-radius:12px;overflow:hidden;">
                  <thead>
                    <tr>
                      <th align="left" style="padding:12px 14px;background:#faf7f2;border-bottom:1px solid #eee;font:700 12px/1 Inter,Arial,sans-serif;color:#6b7280;letter-spacing:.5px;text-transform:uppercase;">Код</th>
                      <th align="right" style="padding:12px 14px;background:#faf7f2;border-bottom:1px solid #eee;font:700 12px/1 Inter,Arial,sans-serif;color:#6b7280;letter-spacing:.5px;text-transform:uppercase;">Баланс</th>
                    </tr>
                  </thead>
                  <tbody>
                    ${codeRows}
            ...
            <tr>
              <td style="padding:0 28px 28px;">
                <div style="font:400 12px/1.6 Inter,Arial,sans-serif;color:#6b7280;">
                  Используйте код при бронировании Rubikiai Lux (при наличии мест). Не подлежит возврату. Если нужна помощь, свяжитесь info@rubikiailux.lt.
                </div>
              </td>
            </tr>
          </table>

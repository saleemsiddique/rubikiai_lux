            ...
            <tr>
              <td style="padding:14px 22px 6px;">
                <div style="font:500 15px Inter,Arial,sans-serif;color:#334155;line-height:1.6;">
                  Мы рады принять вас в <strong>${displayName}</strong> <strong>${checkInFmt}</strong>${checkOut ? ` до ${checkOutFmt}` : ""}. Рекомендуем взять резиновые (пляжные) тапочки для прохода по террасе до джакузи. Будете ли вы пользоваться грилем, 10€ (дрова, уголь, решетки, шампуры, инструменты...)? Водите осторожно, в нашем районе много диких животных. <br/><br/>Пожалуйста, ознакомьтесь с информацией о доме и правилами ниже.
                </div>
              </td>
            </tr>

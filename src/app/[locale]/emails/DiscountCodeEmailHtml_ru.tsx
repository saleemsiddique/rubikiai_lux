...
export function DiscountCodeEmailHtml_ru(params: any): string {
          ...
          <tr>
            <td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; padding: 30px;">
                ...
                <tr>
                  <td align="center">
                    <h1 style="color: #2a4850; margin: 0 0 20px 0;">Ваша персональная скидка</h1>
                    <p style="font-size: 18px; color: #666;">Вы получили скидку ${percent}% для Rubikiai Lux!</p>
                    ...
                    <div style="background: linear-gradient(135deg, #d4b996 0%, #c9a87a 100%); border-radius: 12px; padding: 30px; margin: 30px 0; text-align: center;">
                      <p style="color: #2a4850; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 10px 0;">Ваш код скидки</p>
                      ...
                      <p style="color: #2a4850; font-size: 24px; font-weight: 700; margin: 20px 0 0 0;">СКИДКА ${percent}%</p>
                    </div>

                    <p style="color: #666; margin: 20px 0;">
                      Используйте этот код при бронировании вашего пребывания в Rubikiai Lux.
                      ${expiresAt ? `Действителен до ${expiresAt}.` : ''}
                    </p>

                    <p style="color: #888; font-size: 14px; margin: 10px 0; font-style: italic;">
                      *Скидка применяется к общей стоимости проживания.
                    </p>

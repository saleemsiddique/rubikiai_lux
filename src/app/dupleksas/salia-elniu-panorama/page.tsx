...
const ElniuPanoramaPage: React.FC = () => {
  ...
  // client-side fallbacks en query (no los usamos como fuente primaria)
  ...
  const houseSlug = "salia-elniu-panorama";

  // buscamos el houseId real en el mapping centralizado (lib/houseRoutes.ts)
  ...
  useEffect(() => {
    // si no hay mapping, no hacemos la llamada
    if (!houseIdFromMapping) {
      setPriceError("House mapping not found. Add this house to lib/houseRoutes.ts");
    ...
    const fetchPrice = async () => {
      ...
      // probamos dos rutas por compatibilidad
      ...
      for (const ep of endpoints) {
        try {
          ...
          if (!res.ok) {
            ...
            if (res.status === 404) continue; // intentar siguiente endpoint
          ...
          // seguimos el bucle para intentar el siguiente endpoint
        }
      }
  ...
  const handleReserveNow = () => {
    ...
    // no confiamos en precios pasados por query; los incluimos si existen (opcional)
  ...
  return (
    <main className="bg-gray-100 text-[var(--color-text)]">
      ...
      <div className="relative h-screen">
        <Image src="/dupleksas2.png" alt="Elnių Panorama Duplex" fill style={{ objectFit: "cover" }} className="absolute inset-0 z-0" />
        <div className="absolute inset-0 bg-black opacity-40 z-10" />
        <div className="relative z-20 flex flex-col items-start justify-end h-full p-8 text-white">
          <h1 className="text-4xl md:text-6xl font-extrabold font-header">N°2 - Elnių Panorama</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="card-soft p-6">
                ...
                {/* Payment summary: sólo si hay fechas válidas */}
                {startParam && endParam && (
      ...
      <section className="py-12 bg-white px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="relative w-full h-96 rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d157835.4326558231!2d25.43715878297757!3d55.45785042656!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46e72c8f8d228c21%3A0x633d7c5b61a4c905!2sRubikiai%20lake!5e0!3m2!1sen!2ses!4v1698716301138!5m2!1sen!2ses"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
...
export default ElniuPanoramaPage;

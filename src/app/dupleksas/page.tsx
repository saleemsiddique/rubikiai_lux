...
const DuplexSelectionPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[var(--color-background-soft)] pt-20 px-4 pb-8 flex flex-col">
      {/* Simple Header */}
      <div className="text-center mb-6 md:mb-8">
        <h1 className="text-2xl md:text-4xl font-bold text-[var(--color-text)] font-header mb-2">
          Pasirinkite dvipusį butą
        </h1>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <div className="p-4 md:p-6">
            <div className="w-12 h-1 bg-[var(--color-primary)] mb-3"></div>
            <h2 className="text-xl md:text-2xl font-bold text-[var(--color-secondary)] group-hover:text-[var(--color-primary)] transition-colors mb-2 font-header">

  ...
  const handleGoToCheckout = async () => {
    ...
    try {
      const body = {
        ...
        // Datos del cliente, que antes intentabas pasar desde HousePage
        customer: {
          email,
        ...
        // Extras que necesitamos guardar en la reserva / stripe metadata
        extras: {
          jacuzzi: withJacuzzi
            ? {
                enabled: true,
                price: priceData.jacuzziFee, // lo que calculó backend para jacuzzi
              }
            : { enabled: false },
        },
      };
            ...
            <label className="flex items-start gap-4 cursor-pointer">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600 leading-relaxed">
                  65€ incluye hasta 2 personas. +10€ por cada huésped adicional.
                </div>
              </div>
            </label>
          </div>
            ...
            <div className="text-sm text-gray-700 space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {startIso ? new Date(startIso).toLocaleDateString() : "-"}
                </span>
              </div>
              ...
              {withJacuzzi && priceData && (
                <div className="flex justify-between text-[var(--color-primary-dark)] font-semibold">
                  <span>Jacuzzi</span>
                  <span>+{priceData.jacuzziFee}€</span>
                </div>
              )}
              ...
              {firstNightCharge !== null && (
                <div className="mt-4 text-xs text-gray-600 leading-relaxed">
                  El pago inicial en el checkout será aprox. {firstNightCharge}€.  
                  El resto (y el jacuzzi si aplica) se termina de formalizar según las condiciones de llegada.
                </div>
              )}
            </div>
          </div>
